#!/usr/bin/env python3
"""프마드｜FROM MY DREAM PROJECT 진학설계 웹 앱(프로토타입) — Streamlit
...
st.set_page_config(page_title='프마드｜FROM MY DREAM PROJECT', page_icon='🧭', layout='wide')
st.title('🧭 프마드｜FROM MY DREAM PROJECT')
st.caption('꿈에서 시작해, 오늘의 길을 찾다 — 꿈에서 시작하는 개인 맞춤 진학설계')
